...
VICTOR_PULL_US = env_int("QUADPOD_VICTOR_PULL_US", 1600)
...
FAILURE_DROP_LBS = env_float("QUADPOD_FAILURE_DROP_LBS", 2.0)
MAX_FORCE_LBS = env_float("QUADPOD_MAX_FORCE_LBS", 400.0)
MAX_TEST_SECONDS = env_float("QUADPOD_MAX_TEST_SECONDS", 120.0)
