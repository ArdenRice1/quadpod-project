...
VICTOR_REVERSE_US = env_int("QUADPOD_VICTOR_REVERSE_US", 997)
VICTOR_JOG_US = env_int("QUADPOD_VICTOR_JOG_US", 1850)
...
PRELOAD_TOLERANCE_LBS = env_float("QUADPOD_PRELOAD_TOLERANCE_LBS", 0.5)
FAILURE_DROP_LBS = env_float("QUADPOD_FAILURE_DROP_LBS", 5.0)
FAILURE_DROP_PERCENT = env_float("QUADPOD_FAILURE_DROP_PERCENT", 0.15)
FAILURE_CONFIRM_SAMPLES = env_int("QUADPOD_FAILURE_CONFIRM_SAMPLES", 3)
FAILURE_MIN_PEAK_LBS = env_float("QUADPOD_FAILURE_MIN_PEAK_LBS", 15.0)
