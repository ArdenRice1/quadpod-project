...
PRELOAD_AUTO_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_SPEED_PERCENT", 100)
PRELOAD_AUTO_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_PULSE_SECONDS", 0.06)
PRELOAD_AUTO_SETTLE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_SETTLE_SECONDS", 2.0)
PRELOAD_AUTO_SETTLE_MAX_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_SETTLE_MAX_SECONDS", 4.0)
