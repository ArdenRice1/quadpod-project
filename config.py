...
PRELOAD_AUTO_ABORT_LBS = env_float("QUADPOD_PRELOAD_AUTO_ABORT_LBS", 20.0)
...
PRELOAD_AUTO_TIMEOUT_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_TIMEOUT_SECONDS", 90.0)
...
PRELOAD_AUTO_SLACK_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_SLACK_SPEED_PERCENT", 80)
PRELOAD_AUTO_SLACK_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_SLACK_PULSE_SECONDS", 1.0)
PRELOAD_AUTO_COARSE_UNTIL_LBS = env_float("QUADPOD_PRELOAD_AUTO_COARSE_UNTIL_LBS", 3.0)
PRELOAD_AUTO_COARSE_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_COARSE_SPEED_PERCENT", 70)
PRELOAD_AUTO_COARSE_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_COARSE_PULSE_SECONDS", 0.3)
PRELOAD_AUTO_APPROACH_UNTIL_LBS = env_float("QUADPOD_PRELOAD_AUTO_APPROACH_UNTIL_LBS", 8.0)
PRELOAD_AUTO_APPROACH_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_APPROACH_SPEED_PERCENT", 50)
PRELOAD_AUTO_APPROACH_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_APPROACH_PULSE_SECONDS", 0.3)
PRELOAD_AUTO_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_PULSE_SECONDS", 0.1)
PRELOAD_AUTO_DOWN_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_DOWN_PULSE_SECONDS", 0.04)
