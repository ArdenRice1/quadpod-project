...
PRELOAD_MAX_LBS = env_float("QUADPOD_PRELOAD_MAX_LBS", 0.25)
...
PRELOAD_AUTO_STOP_DURING_LOAD_READ = env_bool("QUADPOD_PRELOAD_AUTO_STOP_DURING_LOAD_READ", False)
PRELOAD_AUTO_CONTROL_CONFIRM_SAMPLES = env_int("QUADPOD_PRELOAD_AUTO_CONTROL_CONFIRM_SAMPLES", 5)
PRELOAD_AUTO_CONTROL_SPIKE_DELTA_LBS = env_float("QUADPOD_PRELOAD_AUTO_CONTROL_SPIKE_DELTA_LBS", 5.0)
...
PRELOAD_AUTO_CONTINUOUS_MAX_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_CONTINUOUS_MAX_SPEED_PERCENT", 55)
PRELOAD_AUTO_CONTINUOUS_KP = env_float("QUADPOD_PRELOAD_AUTO_CONTINUOUS_KP", 30.0)
PRELOAD_AUTO_CONTINUOUS_KD = env_float("QUADPOD_PRELOAD_AUTO_CONTINUOUS_KD", 10.0)
PRELOAD_AUTO_CONTINUOUS_RAMP_PERCENT_PER_SECOND = env_float(
    "QUADPOD_PRELOAD_AUTO_CONTINUOUS_RAMP_PERCENT_PER_SECOND",
    70.0,
)
PRELOAD_AUTO_CONTINUOUS_BRAKE_MARGIN_LBS = env_float("QUADPOD_PRELOAD_AUTO_CONTINUOUS_BRAKE_MARGIN_LBS", 0.08)
...
PRELOAD_HOLD_TRIM_INTERVAL_SECONDS = env_float("QUADPOD_PRELOAD_HOLD_TRIM_INTERVAL_SECONDS", 0.25)
