...
PRELOAD_AUTO_SLACK_UNTIL_LBS = env_float("QUADPOD_PRELOAD_AUTO_SLACK_UNTIL_LBS", 1.0)
PRELOAD_AUTO_SLACK_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_SLACK_SPEED_PERCENT", 90)
PRELOAD_AUTO_SLACK_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_SLACK_PULSE_SECONDS", 0.5)
PRELOAD_AUTO_COARSE_UNTIL_LBS = env_float("QUADPOD_PRELOAD_AUTO_COARSE_UNTIL_LBS", 3.0)
PRELOAD_AUTO_COARSE_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_COARSE_SPEED_PERCENT", 55)
PRELOAD_AUTO_COARSE_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_COARSE_PULSE_SECONDS", 0.12)
PRELOAD_AUTO_APPROACH_UNTIL_LBS = env_float("QUADPOD_PRELOAD_AUTO_APPROACH_UNTIL_LBS", 6.0)
PRELOAD_AUTO_APPROACH_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_APPROACH_SPEED_PERCENT", 40)
PRELOAD_AUTO_APPROACH_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_APPROACH_PULSE_SECONDS", 0.08)
PRELOAD_AUTO_SLOW_UNTIL_LBS = env_float("QUADPOD_PRELOAD_AUTO_SLOW_UNTIL_LBS", 8.0)
PRELOAD_AUTO_SLOW_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_SLOW_SPEED_PERCENT", 28)
PRELOAD_AUTO_SLOW_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_SLOW_PULSE_SECONDS", 0.05)
PRELOAD_AUTO_FINE_UNTIL_LBS = env_float("QUADPOD_PRELOAD_AUTO_FINE_UNTIL_LBS", 8.7)
PRELOAD_AUTO_FINE_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_FINE_SPEED_PERCENT", 20)
PRELOAD_AUTO_FINE_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_FINE_PULSE_SECONDS", 0.03)
PRELOAD_AUTO_MICRO_UNTIL_LBS = env_float("QUADPOD_PRELOAD_AUTO_MICRO_UNTIL_LBS", 9.1)
PRELOAD_AUTO_MICRO_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_MICRO_SPEED_PERCENT", 16)
PRELOAD_AUTO_MICRO_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_MICRO_PULSE_SECONDS", 0.02)
PRELOAD_AUTO_TRIM_UNTIL_LBS = env_float("QUADPOD_PRELOAD_AUTO_TRIM_UNTIL_LBS", 9.3)
PRELOAD_AUTO_TRIM_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_TRIM_SPEED_PERCENT", 13)
PRELOAD_AUTO_TRIM_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_TRIM_PULSE_SECONDS", 0.015)
PRELOAD_AUTO_FEATHER_UNTIL_LBS = env_float("QUADPOD_PRELOAD_AUTO_FEATHER_UNTIL_LBS", 9.42)
PRELOAD_AUTO_FEATHER_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_FEATHER_SPEED_PERCENT", 11)
PRELOAD_AUTO_FEATHER_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_FEATHER_PULSE_SECONDS", 0.01)
