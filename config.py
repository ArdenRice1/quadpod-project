...
LOADCELL_CONTROL_SAMPLES = env_int("QUADPOD_LOADCELL_CONTROL_SAMPLES", 1)
...
PRELOAD_AUTO_PREDICT_STOP_LBS = env_float("QUADPOD_PRELOAD_AUTO_PREDICT_STOP_LBS", 0.0)
PRELOAD_AUTO_PREDICT_LOOKAHEAD_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_PREDICT_LOOKAHEAD_SECONDS", 0.75)
PRELOAD_AUTO_RATE_WINDOW_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_RATE_WINDOW_SECONDS", 0.75)
PRELOAD_AUTO_MAX_RISE_RATE_LBS_PER_SECOND = env_float("QUADPOD_PRELOAD_AUTO_MAX_RISE_RATE_LBS_PER_SECOND", 0.25)
