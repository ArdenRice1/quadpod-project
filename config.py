...
PRELOAD_AUTO_CONTINUOUS_MAX_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_CONTINUOUS_MAX_SPEED_PERCENT", 18)
PRELOAD_AUTO_CONTINUOUS_KP = env_float("QUADPOD_PRELOAD_AUTO_CONTINUOUS_KP", 8.0)
...
PRELOAD_AUTO_CONTINUOUS_CRAWL_ZONE_LBS = env_float("QUADPOD_PRELOAD_AUTO_CONTINUOUS_CRAWL_ZONE_LBS", 0.75)
...
PRELOAD_AUTO_INITIAL_STOP_LBS = env_float("QUADPOD_PRELOAD_AUTO_INITIAL_STOP_LBS", -0.60)
