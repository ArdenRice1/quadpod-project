...
PRELOAD_AUTO_INITIAL_STOP_LBS = env_float("QUADPOD_PRELOAD_AUTO_INITIAL_STOP_LBS", -0.5)
PRELOAD_AUTO_FINAL_APPROACH_STOP_LBS = env_float("QUADPOD_PRELOAD_AUTO_FINAL_APPROACH_STOP_LBS", -0.75)
PRELOAD_AUTO_FINAL_REBRAKE_MARGIN_LBS = env_float("QUADPOD_PRELOAD_AUTO_FINAL_REBRAKE_MARGIN_LBS", 0.25)
