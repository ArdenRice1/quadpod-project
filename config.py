...
PRELOAD_AUTO_CONTINUOUS_MAX_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_CONTINUOUS_MAX_SPEED_PERCENT", 20)
PRELOAD_AUTO_CONTINUOUS_KP = env_float("QUADPOD_PRELOAD_AUTO_CONTINUOUS_KP", 9.0)
