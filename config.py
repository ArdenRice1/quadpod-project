...
PRELOAD_AUTO_CONTACT_MAX_DELTA_LBS = env_float("QUADPOD_PRELOAD_AUTO_CONTACT_MAX_DELTA_LBS", 0.25)
PRELOAD_AUTO_CONTACT_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_CONTACT_SPEED_PERCENT", 35)
PRELOAD_AUTO_CONTACT_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_CONTACT_PULSE_SECONDS", 0.05)
