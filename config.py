...
PRELOAD_AUTO_COARSE_SPEED_PERCENT = env_int("QUADPOD_PRELOAD_AUTO_COARSE_SPEED_PERCENT", 65)
PRELOAD_AUTO_COARSE_PULSE_SECONDS = env_float("QUADPOD_PRELOAD_AUTO_COARSE_PULSE_SECONDS", 0.03)
